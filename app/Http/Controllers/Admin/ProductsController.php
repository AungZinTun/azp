...
class ProductsController extends Controller
{
    ...
    public function create()
    {
        ...
        $albums = \App\Album::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');

        return view('admin.products.create', compact('categories', 'tags', 'albums'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.products.edit', compact('product', 'categories', 'tags', 'albums'));
    }
    ...
    public function show($id)
    {
        ...
        $albums = \App\Album::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$clients = \App\Client::whereHas('photo',
