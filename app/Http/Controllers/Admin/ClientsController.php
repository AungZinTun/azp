...
class ClientsController extends Controller
{
    ...
    public function create()
    {
        ...
        $categories = \App\ProductCategory::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
        $photos = \App\Product::get()->pluck('photo1', 'id');


        return view('admin.clients.create', compact('categories', 'photos'));
    }
    ...
    public function store(StoreClientsRequest $request)
    {
        ...
        $client->photo()->sync(array_filter((array)$request->input('photo')));
    ...
    public function edit($id)
    {
        ...
        return view('admin.clients.edit', compact('client', 'categories', 'photos'));
    }
