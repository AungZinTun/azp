	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			...
			<div class="hs-item set-bg sp-pad" data-setbg="img/hero-slider/2.jpg">
				<div class="hs-text">
					<h2 class="hs-title">Hello </h2>
					<p class="hs-des">We guarenteed <br>You will get satisfaction</p>
				</div>
			</div>
		</div>
	</section>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">AZ Photography</a>
